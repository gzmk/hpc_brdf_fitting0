...
% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/hpc_brdf_fitting0');
...
imPath = ['/scratch/gk925/hpc_brdf_fitting0/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
